    ...
    <form action="{{route('admin.solicitacao.store')}}" class="needs-validation" novalidate method="post"
        ...
        <div class="row">
            <div class="input-group mb-3 col-12">
                ...
                <select class="custom-select" id="inputGroupSelect01" name="status">
                    ...
                    <option value="Em avaliação">Pedido em avaliação</option>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom02" name="sobrenome" placeholder="Sobrenome"
                       required>
                <div class="valid-feedback">
                    Tudo certo!
                </div>
        ...
        <div class="row">
            <div class="col-lg-4 mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="validationCustomTelefone" name="cpf" placeholder="CPF"
            ...
            <div class="col-lg-4 mb-3">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="validationCustomTelefone" name="idade"
                           placeholder="idade" aria-describedby="inputGroupPrepend" required>
                    <div class="invalid-feedback">
        ...
        <div class="row">
            <div class="col-lg-6 mb-3">
                ...
                <input type="text" class="form-control" id="validationCustom01" name="telefone" placeholder="telefone"
                       required>
                <div class="valid-feedback">
                    Tudo certo!
                </div>
        ...
        <div class="row">
            <div class="col-12 text-right">
                <button class="btn btn-success my-3 col-12 col-lg-2" type="submit">Concluir!</button>
            </div>
        </div>
