    ...
    <input type="file" name="imagem" id="imagem"  value="">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                ...
                <input type="text" class="form-control" id="titulo" value="{{$blog->titulo}}"  name="titulo">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control col-sm-11" name="mensagem"  id="mensagem" rows="3">{{$blog->mensagem}}</textarea>
           </div>
