...
<!-- Botão do Whatsapp -->
<div>
    <a href="https://api.whatsapp.com/send?phone=0&amp;text=Queria%20falar%20com%20um%20atendente%20da%20Anipat!"
       target="_blank"><img class="whatsapp"
                            src="https://3.bp.blogspot.com/-ckiKOobNJy8/XRIGyySxDII/AAAAAAAACv0/09JFzT4vlcUYHq19lu-pQfWjYq6dyKYzQCLcBGAs/s1600/contatowhats.png"></a>
</div>
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    ...
                                    <a href="{{ route('front.contato')}}"
                                       class="ml-0 ml-lg-3 btn btn-warning btn-rounded text-light">MINHAS
                                        SOLICITAÇÕES</a>
                                </ul>
                            </nav>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p>Copyright &copy; {{ date('Y') }} Todos os direitos reservados | Projeto feito com <i
                                class="ti-heart" aria-hidden="true"></i> por Suellen, Raquel, Tiago, Vitor e Josué.</p>
                    </p>
                </div>
            </div>
        </div>
